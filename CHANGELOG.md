...
- Accounts a block only reads are no longer rewritten into the flat database, the account trie and the trie log on persist. [#11324](https://github.com/besu-eth/besu/pull/11324)
