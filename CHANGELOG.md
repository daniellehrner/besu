...
- Backward sync no longer re-executes a block already known as bad, and a block that imports successfully is forgotten by the bad-block caches together with the descendants marked on its account. [#11373](https://github.com/besu-eth/besu/pull/11373)
