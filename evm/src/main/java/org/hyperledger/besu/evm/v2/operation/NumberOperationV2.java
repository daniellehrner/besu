...
/** EVM v2 NUMBER operation — pushes the block number onto the stack. */
public class NumberOperationV2 extends AbstractFixedCostOperationV2 {

  private static final OperationResult numberSuccess = new OperationResult(2, null);
  ...
  public static OperationResult staticOperation(final MessageFrame frame, final long[] stack) {
    ...
    frame.setTopV2(
        StackArithmetic.pushLong(stack, frame.stackTopV2(), frame.getBlockValues().getNumber()));
